...
class ResidentsControllerTest < ActionController::TestCase
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post :create, resident: { date: @resident.date, date_of_undeath: @resident.date_of_undeath, name: @resident.name, on_diet: @resident.on_diet, picture: @resident.picture, recruitment_tally: @resident.recruitment_tally }
    end
  ...
  test "should update resident" do
    patch :update, id: @resident, resident: { date: @resident.date, date_of_undeath: @resident.date_of_undeath, name: @resident.name, on_diet: @resident.on_diet, picture: @resident.picture, recruitment_tally: @resident.recruitment_tally }
    assert_redirected_to resident_path(assigns(:resident))
  end
