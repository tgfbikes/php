...
class ParentsControllerTest < ActionController::TestCase
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post :create, parent: { age: @parent.age, fname: @parent.fname, lname: @parent.lname, sex: @parent.sex }
    end
  ...
  test "should update parent" do
    patch :update, id: @parent, parent: { age: @parent.age, fname: @parent.fname, lname: @parent.lname, sex: @parent.sex }
    assert_redirected_to parent_path(assigns(:parent))
  end
